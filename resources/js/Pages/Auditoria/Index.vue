<template>
  ...
  <AuthenticatedLayout :breadCrumbLinks="breadcrumbLinks">
    <template #header> Auditoria votaciones </template>
        ...
        <div class="inline-block min-w-full py-2">
          <div class="overflow-x-auto">
            <table class="min-w-full whitespace-no-wrap">
              ...
              <tbody>
                <tr
                  v-for="user in voto_auditoria.data"
                  :key="user.id"
                  class="text-gray-700"
                >
                  <td
                    class="border-b border-gray-200 bg-white p-1 text-sm"
                  >
                    <Avatar
                  ...
                  <td
                    class="border-b border-gray-200 bg-white py-5 text-sm"
                  >
    ...
    >
      <pagination :links="voto_auditoria.links" />
    </div>
  </AuthenticatedLayout>
</template>
