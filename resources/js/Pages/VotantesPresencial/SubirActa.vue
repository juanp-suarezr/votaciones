    ...
    <AuthenticatedLayout :breadCrumbLinks="breadcrumbLinks">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <form
                ...
                class="md:grid md:grid-cols-2 gap-4 p-6"
            >
                <!-- contenido 1 -->
                <div class="bg-white p-4 rounded-lg shadow h-auto">
                    <h2 class="text-lg font-semibold mb-4">
                        Subir acta de escrutinio
                    </h2>
              ...
              />
                        ...
                        <div class="mb-2">
                            ...
                            />
                            <InputError
                                :message="form.errors.fecha_evento"
                                class="mt-2"
                            />
                        </div>
                        ...
                        <div class="mb-2 w-full">
                            ...
                            >
                                ...
                                <span v-if="isMaxPalabras"
                                    >Limite de caracteres superado</span
                                >
                            </p>
                            <InputError
                        ...
                        <div class="mb-2 w-1/4">
                            ...
                            />
                            <InputError
                                :message="form.errors.votos_blancos"
                                class="mt-2"
                            />
                        </div>
                        <!-- votos no marcados -->
                        <div class="mb-2 w-1/4">
                            <InputLabel
                                for="votos_no_marcados"
                                value="Votos no marcados"
                            />
                            <TextInput
                        ...
                        <div class="mb-2 w-1/4">
                            ...
                            />
                            <InputError
                                :message="form.errors.votos_nulos"
                                class="mt-2"
                            />
                        </div>
                ...
                <div
                    class="flex justify-center items-center w-full col-span-2 mt-4"
                >
                    <PrimaryButton
                        class="w-auto"
...
const form = useForm({
    ...
    fecha_evento: new Date().toLocaleDateString("en-CA"),
    votos_nulos: 0,
    votos_blancos: 0,
    votos_no_marcados: 0,
    total_ciudadanos: 0,
